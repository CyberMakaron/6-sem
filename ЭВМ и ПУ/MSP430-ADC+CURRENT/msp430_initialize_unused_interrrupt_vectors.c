...
TIMERA1_VECTOR          (5 * 1u)       0xFFEA Timer A CC1-2, TA // Прерывание используется
...
#pragma vector=DACDMA_VECTOR,PORT2_VECTOR,USART1TX_VECTOR,USART1RX_VECTOR,PORT1_VECTOR,  \
