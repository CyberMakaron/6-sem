;r0 - количество переполнений таймера, 15 переполнений - 1 секунда
;r1 - счетчик секунд (0-59)
;r2 - счетчик единиц минут (0-9)
;r3 - счетчик десятков минут (0-5)
;r4 - счетчик единиц часов (0-9)
;r5 - счетчик десятков часов (0-2)
;r6 - флаг точки секунд
